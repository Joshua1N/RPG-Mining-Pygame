...
class DemtreuisDemarcusDejamesDathird(pygame.sprite.Sprite):
    def __init__(self, char_type, x, y, speed):
        ...
        self.flip = False
        self.loaded = False
        img = pygame.image.load('C:/Users/jlnelson/PycharmProjects/RPG-Mining-Pygame-main/retard/assets/demtreuis-demarcus-dejames-dathird.png').convert_alpha()
        ...
        self.demtreuis_demarcus_dejames_dathird_running = True
        self.gold = 0
    ...
    def walking(self):
        if not self.loaded:
            ...
            if self.rect.x >= 1920 - 170:
                self.loaded = True
                self.demtreuis_demarcus_dejames_dathird_running = False
